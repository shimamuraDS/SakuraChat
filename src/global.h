...
enum ReqId {
    ...
    ID_CHAT_HISTORY_REQ = 1020,
    ID_CHAT_HISTORY_RSP = 1021,
    ID_MESSAGE_RECEIPT_REQ = 1022,
    ID_MESSAGE_RECEIPT_RSP = 1023,
    ID_MESSAGE_STATUS_REQ = 1024,
    ID_MESSAGE_STATUS_RSP = 1025,
    ID_CONVERSATION_LIST_REQ = 1026,
    ID_CONVERSATION_LIST_RSP = 1027,
    ID_PRIVACY_REQ = 1040,
    ID_PRIVACY_RSP = 1041,
    ID_LOGOUT_REQ = 1042,
    ID_MESSAGE_DELETE_REQ = 1044,
    ID_MESSAGE_DELETE_RSP = 1045,
    ID_DELETION_EVENTS_REQ = 1046,
    ID_DELETION_EVENTS_RSP = 1047,
};
